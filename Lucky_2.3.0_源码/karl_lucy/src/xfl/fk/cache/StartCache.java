...
public class StartCache {
	 ...
	 */
	@Deprecated
	public boolean deleteByIdCache(String tableName, int id) {
	 ...
	 * @return
	 */
	public boolean saveBatchCache(Object...obj) {
		for(Object o:obj)
			saveCache(o);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean deleteBatchCache(Object...obj) {
		for(Object o:obj)
			deleteCache(o);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean updateBatchCache(Object...obj) {
		for(Object o:obj)
			updateCache(o);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean deleteBatch(Class clzz,int...ids) {
		for(int i:ids)
			delete(clzz, i);
		return true;
	}
	 ...
	 * @return
	 */
	public boolean deleteBatchCache(Class clzz,int...ids) {
		for(int i:ids)
			deleteCache(clzz, i);
		return true;
	}
